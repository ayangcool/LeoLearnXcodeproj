...
# 执行shell命令，把 PersonFile文件夹及Person.h Person.m 复制到 LeoXcodeProjDemo 文件夹里
system 'cp -rf ../testFile/PersonFile ./LeoXcodeProjDemo/PersonFile'

# 添加 PersonFile 文件夹
preson_file = project.main_group.find_subpath(File.join('LeoXcodeProjDemo', 'PersonFile'), true)
preson_file.set_source_tree('<group>')
preson_file.set_path('PersonFile')
